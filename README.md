...
```bash
npm create cloudflare@latest -- --template=cloudflare/templates/mute-leaf-be22
```

A live public deployment of this template is available at [https://mute-leaf-be22.templates.workers.dev](https://mute-leaf-be22.templates.workers.dev)
